# Used the sonifyImage.py example from https://jythonmusic.me/code-examples/, provided grayscale image instead of the existing image
#
...
try:
    ...
    print "Please import all the packages"
...
image = Image("imagesAndData/grayscale.jpg")
